...
const MeeqatTV = (() => {
  ...
  function showPairingScreen() {
    ...
    // Use pair code already generated by inline script, or generate new one
    pairCode = window.__pairCode || generatePairCode();
    window.__pairCode = pairCode;

    // Update digit display (may already be set by inline script)
